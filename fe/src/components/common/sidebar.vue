<template>
    <div class="sidebar" ref="sidebar">
        <el-menu :router="true" default-active="data-collection" @open="handleOpen" @close="handleClose" theme="light">
            <el-menu-item index="data-collection">数据统计</el-menu-item>
            <el-submenu index="1">
                <template slot="title">租用管理</template>
                <el-menu-item index="rented-house-list">已租用房屋</el-menu-item>
                <el-menu-item index="1-1">未租用房屋</el-menu-item>
                <el-menu-item index="1-2">添加新租户</el-menu-item>
